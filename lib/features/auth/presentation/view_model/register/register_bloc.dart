...
//   void _onTogglePasswordVisibility(TogglePasswordVisibilityEvent event, Emitter<RegisterState> emit) {
//     emit(state.copyWith(isPasswordVisible: !state.isPasswordVisible));
//   }

//   void _onNavigateToLogin(NavigateToLoginEvent event, Emitter<RegisterState> emit) {
//     Navigator.pushReplacement(
//       event.context,
//       MaterialPageRoute(
//         builder: (context) => BlocProvider(
